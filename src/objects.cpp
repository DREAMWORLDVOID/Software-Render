...
void renderCube() {
    ...
    Mat44 rotMat = rotateY(30);
    Mat44 transMat = translate(0, 1, 0);
    Mat44 scaleMat = scale(1);
...
void renderSquare() {
    modelMatrix.LoadIdentity();
    Mat44 transMat = translate(0, 0, 0);
    Mat44 scaleMat = scale(50);
...
void renderSphere() {
    //blendFlag=true;
    modelMatrix.LoadIdentity();
    Mat44 transMat = translate(-2, 3, 2);
